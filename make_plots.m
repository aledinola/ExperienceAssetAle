...
tot_income = stat_age.ym_coh+stat_age.yf_coh+stat_age.pen_coh;
...
hold on
plot(ages,stat_age.c_coh,'LineWidth',2)
hold on
plot(ages,stat_age.c_eq_coh,'--','LineWidth',2)
...
subplot(2,2,2)
plot(ages(1:ra-1),stat_age.yf_coh(1:ra-1),'LineWidth',2)
hold on
plot(ages(1:ra-1),stat_age.ym_coh(1:ra-1),'LineWidth',2)
...
subplot(2,2,3)
plot(ages(1:ra-1),stat_age.l_coh(1:ra-1),'LineWidth',2)
ylim([0,1])
xlabel('Age j')
ylabel('Female labor force particip.')

subplot(2,2,4)
plot(ages(1:ra-1),stat_age.h_coh(1:ra-1),'LineWidth',2)
hold on
...
figure
plot(ages,stat_age.a_coh,'LineWidth',2)
xlabel('Age j')
ylabel('Wealth (mean)')
